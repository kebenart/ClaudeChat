...
import { RunningSessionsList, type SessionMeta } from './RunningSessionsList';
...
type SidebarContentProps = {
  ...
  onShowSettings: () => void;
  onRunningSessionSelect: (session: SessionMeta) => void;
    ...
    >
      ...
      <ScrollArea className="flex-1 overflow-y-auto overscroll-contain md:px-1.5 md:py-2">
        {showConversationSearch ? (
          ...
          <RunningSessionsList onSelect={onRunningSessionSelect} onNewSession={onNewSession} />
        )}
      </ScrollArea>
